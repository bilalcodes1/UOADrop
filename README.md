...
نظام إدارة طلبات الطباعة داخل المكتبة الجامعية. النسخة الحالية تعمل كـ **Desktop-first / Local-first** مع مسار Online اختياري: الطالب يستطيع الرفع من شبكة المكتبة محلياً أو من موقع الويب، بينما أمين المكتبة يدير كل الطلبات من تطبيق Electron.
