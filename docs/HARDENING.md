...
- **ملاحظة على التنفيذ الحالي**: النسخة الحالية تربط الخادم على `0.0.0.0` عمداً لأن مسار التشغيل الرسمي هو داخل شبكة المكتبة المحلية، مع الاعتماد على إعداد الشبكة المحلية والجدار الناري والتعليمات التشغيلية في `SETUP.md`.
- **موثّق في**: `ARCHITECTURE.md §8`.
